...
(function($){
	...
	SEMICOLON.initialize = {
		...
		init: function(){
			...
			SEMICOLON.initialize.scrollieFullScreen();
		...
		scrollieFullScreen: function(){
			if( $scrollieElement.length > 0 ) {
				if( $body.hasClass('device-sm') || $body.hasClass('device-xs') ) {
					$scrollieElement.css({ 'height': 'auto' });
				}
			}
		},		
...
/* 			SEMICOLON.header.topsocial(); */
	...
	var $window = $(window),
		...
		$scrollieElement = $('.scrollie-section'),
		swiperSlider = '',
